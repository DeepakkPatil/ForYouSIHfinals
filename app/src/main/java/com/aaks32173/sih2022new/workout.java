...
public class workout extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout btn1 = findViewById(R.id.workout1);
        LinearLayout btn2 = findViewById(R.id.workout2);
        LinearLayout btn3 = findViewById(R.id.workout3);
        LinearLayout btn4 = findViewById(R.id.workout4);
        LinearLayout btn5 = findViewById(R.id.workout5);
